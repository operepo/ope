...
project_name = "sync_media_files"
main_file = "sync_media_files.py"
...
os.system("python -m PyInstaller --hidden-import sip --hidden-import win32timezone --noconfirm --name {0} {1}".format(project_name, main_file))
# --icon logo_icon.ico
