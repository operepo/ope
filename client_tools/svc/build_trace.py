...
if os.path.exists(spec_file):
    os.unlink(spec_file)
#--noconsole
build_params = "python -m PyInstaller --hidden-import sip --hidden-import win32timezone " + \
    "--noupx --add-binary logo_icon.ico;. --noconfirm --icon logo_icon.ico "
