...
os.system("python -m PyInstaller --noconfirm --noconsole --name {0} --icon logo_icon.ico {1}".format(project_name, main_file))
...
os.system("python -m PyInstaller --noconfirm --noconsole {0}.spec".format(project_name))
